...
const ListRoom = () => {
    ...
    return (
        <div>
            <Tittle align='left' font='outfit' tittle='Room Listings' subTittle='View, edit, or manage all listed rooms. Keep the information up-to-date to provide the best experience for users.' />
                ...
                <table className='w-full'>
                    <thead className='bg-gray-50'>
                        <tr>
                            ...
                            <th className='py-3 px4 text-gray-800 font-medium max-sm:hidden text-center'>Facility</th>
