...
const Dashboard = () => {
    ...
    return (
        <div>
            <Tittle align='left' font='outfit' tittle='Dashboard' subTittle='Monitor your room listings, ttrack bookings and analyze revenue-all in one place. Stay updated with real-time insights to ensure smooth operations.' />
