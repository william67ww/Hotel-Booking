...
const AddRoom = () => {
    ...
    return (
        <form>
            <Tittle align='left' font='outfit' tittle='Add Room' subTittle='Fill in the details carefully and accurate room details, princing and amenities, to enhance the user booking experience.' />
