        ...
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div>
                <div className='flex flex-col items-start text-left'>
                    ...
                    <p className='text-sm md:text-base text-gray-500/90 mt-2'>Take advantage of our limited-time offers and special packages to enhance your stay and create<br /> unforgettable memorie.</p>
                </div>
                {roomsDummyData.map((room) => (
                    <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                        <img
                            ...
                            className='w-full h-64 md:w-[400px] md:h-64 rounded-xl shadow-lg object-cover cursor-pointer' />
            ...
            <div className={`bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16 min-h-[50px] pb-3`}>
